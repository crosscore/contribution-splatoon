...
/**
 * Serverless endpoint (Vercel /api function): renders the top-languages card
 * from docs/stats.json (regenerated daily by CI) — no GitHub token needed at
...
export default async function handler(
  ...
  res.end(renderLangsSVG(stats, dark, resolveNumeralFont(query.get("font"))));
}
